Hangman is a word-guessing game where players must guess letters to complete a hidden word before the "hangman" is fully drawn. This implementation of the game is built with React and Redux.
